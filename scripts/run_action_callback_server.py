...
def main() -> int:
    ...
    # (effect_boundary.execute_invoice_write), which ships DARK — it has no production caller, and a
    # non-sandbox operation is refused before any claim. Live supervised external writes are enabled
    # and validated at P12, not here.
