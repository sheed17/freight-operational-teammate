...
CASES = [
    ...
    ("M34", CURRENT,
     ...
     f"{_HIDDEN}\n\n</details>\n\n{_ANCHOR}",
     R07_NODE,
     "R-02: the historical marker MOVED OUTSIDE the block it is meant to label. Proximity is not "
     "attachment - one sentence placed above a block would otherwise launder everything inside it"),
    ("M35", CURRENT,
     _ANCHOR,
