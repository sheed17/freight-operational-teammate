...
| **G1** | Pure Domain & Machine Correctness | `AC-MACH-*` (141/141), `AC-DOM-*` (40/40) | **100%** | ### **all SAFETY/FINANCIAL/DATA_INTEGRITY** | full | none | — | — | — | coverage table | tech lead | n/a | none |
| **G2** | Event, Replay & Projection | `AC-EVT-*` (92/92) + `GC-1` digest | **100%** | ### **AC-EVT-007/008/011/013** | full | none | ### **`GC-1` required** | — | — | ### **the pinned digest** | tech lead | n/a | none |
