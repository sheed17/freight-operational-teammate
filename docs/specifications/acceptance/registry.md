...
### **134/134 transitions · 105/105 emitted events · 40/40 domain entities · all adapter operations · 28/28 permanent safety invariants · 16/16 false-closure rules · 40 hostile workflow + 30 adapter + 20 event + 20 cross-machine traces · 11/11 loops · all degraded modes · all release gates.**
*(Errata 2026-07-16: transitions corrected 141→134, emitted events 92→98 — both were propagated arithmetic errors; the underlying per-machine and per-family enumerations were always correct. See `docs/implementation/canonical-corpus-errata-review.md`. Amendment 2026-08-12: emitted events 98→105 — NOT an errata but an authorized mint of seven canonical events discharging the seven recorded `GR-2` obligations.)*
