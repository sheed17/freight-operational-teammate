...
|---|---|---|---|---|---|
| ### **AC-SAFE-012** | ### **GREEN ✔ (P1)** | ### **was: `_commit_identity` included `approved_amount`** | **U1.2** | ### **Phase 1 — DONE** | **G0** |
| ### **AC-SAFE-013** | ### **GREEN ✔ (P1)** | ### **was: `if not amount: return None`** | **U1.3** | ### **Phase 1 — DONE** | **G0** |
