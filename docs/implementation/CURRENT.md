...
**Last updated:** 2026-08-25, at the `P6-CP-5` (M5) landing.
...
| **P6** — foundational entities and state machines | **IN PROGRESS** | five landed checkpoints; see below |
...
returned none. Landing M5 scores no P6 criterion. **The next build checkpoint is M6.**
...
| **Nonblocking debt** | P5: `IR-R5`–`IR-R12`, `ADJ-P5-01`–`ADJ-P5-03`. P6/M1: R-01/R-02/R-03, A-01/A-02/A-03, `P6-D6`, `P6-D8`. P6/M2: `P6-D17`–`P6-D23`, `P6-D9`, `P6-D12`, `P6-D13`. P6/M3: `P6-D29`, `P6-D30`. P6/M4: `P6-D31`–`P6-D34`. P6/M5: `P6-D35`–`P6-D40`. Plus `P6-D24`–`P6-D27` and the G2 residuals. **These are debt rows, and a debt row is a complete deliverable.** Do not open a remediation campaign against them. |
...
| **Rebuilding or polishing M1, M2, M3, M4 or M5** | All five are landed and no further code is owed. Their residuals are debt rows. |
