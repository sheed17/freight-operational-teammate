...
> [`TRANSITION-EVENT-AUDIT.yaml`](TRANSITION-EVENT-AUDIT.yaml) — as do `G2-D11` (AP-9's **unfreeze**
> direction is unmodelled; the sentence asserting it is deleted, not restated) and `G2-D12` (the
