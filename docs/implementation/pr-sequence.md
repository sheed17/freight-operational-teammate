...
**P5:** U5.1 transactional outbox ⇒ `AC-RACE-006/007`; U5.2 dedup inbox ⇒ `AC-ADPT-010`; U5.3 ### **the 105 event contracts** + upcaster *(errata: was 92; founder/architect mint 2026-08-12: 98 → 105)*; U5.4 ### **the `GC-1` golden corpus + pinned digest** ⇒ `AC-EVT-007/008`; U5.5 ### **sandboxed replay — effects structurally unreachable in replay** ⇒ `AC-EVT-011`; ### **U5.6 audit reconstruction (18-field explainability, beliefs-of-that-day)** ⇒ `AC-AUD-*`.
