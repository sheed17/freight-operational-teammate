...
| **Current execution authority** | ### **None. It ships dark.** M1's transitive import closure reaches no effect-capable module — asserted structurally, over every import spelling — it mints zero witnesses and zero grants across all seven reachable states, and a guard asserts the package and `scripts/` contain **zero importers** of `work_item.py` |
