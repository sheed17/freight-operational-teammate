...
| **Current risk** | Low, and bounded by having no caller. The residual risk is scope, not safety — M3–M13 and the remaining 95 transitions are the next units, and three named debts (P6-D11/D12/D13) record where §14 and the event registry leave a seam this unit refused to improvise across |
