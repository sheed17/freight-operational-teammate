...
| **Current risk** | R-07 remains OPEN — the boundary is built and green but **two** effect-capable import edges (EP-1, EP-14) are not yet cut, so ungated paths still exist beside it. EP-8 was cut at U4.7 onto the read-only observer and EP-3 at U4.8 onto the read-only navigator |
